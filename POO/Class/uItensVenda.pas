...
//    raise Exception.Create('O campo Produto é obrigatório.');

  inherited ValidarValor(Value, 'O campo Produto é obrigatório.');
...
begin
//  if Value <= 0 then
//    raise Exception.Create('O campo Qtde é obrigatório.');

  inherited ValidarValor(Value, 'O campo Qtde é obrigatório.');
...
begin
//  if Value <= 0 then
//    raise Exception.Create('O campo Valor Unitário é obrigatório.'); 

  inherited ValidarValor(Value, 'O campo Valor Unitário é obrigatório.');
